...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/js/bootstrap.bundle.min.js" integrity="sha384-b5kHyXgcpbZJO/tY9Ul7kGkf1S0CWuKcCD38l8YkeH8z8QjE0GmW1gYU5S9FOnJ0" crossorigin="anonymous"></script>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <h3 style="text-align:center;margin-left:50px;margin-top:80px;font-size:45px;color:darkgreen;"><u>RTO Gujarat:Approve LLR Application</u></h3>
      <br/><br/>
      <form action="#" method="post">
      <label for="ID" style="margin-left:200px;">LLR ID: </label>
      ...
      <?php
              if(isset($_POST['submit']))
              {
                ...
                $reg_expiry = date('Y-m-d', strtotime($reg_issue. ' + 180 days'));
                $sql = null;
                if ($approve == 1)
                {
                    $sql = "UPDATE LLR SET llr_status = '1' , llr_reg_date = '$reg_issue' , llr_expiry_date = '$reg_expiry' WHERE llr_id = '$id'";
