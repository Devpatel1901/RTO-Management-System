...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/js/bootstrap.bundle.min.js" integrity="sha384-b5kHyXgcpbZJO/tY9Ul7kGkf1S0CWuKcCD38l8YkeH8z8QjE0GmW1gYU5S9FOnJ0" crossorigin="anonymous"></script>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <br/><br/><br/>
      <form action="llr_validate.php" method="post">
      ...
      <label for="birthday" style="margin-left:290px;">Date of Birth: </label>
      <input type="date" name="birthdate" required/><br/><br/>
      <label for="email" style="margin-left:200px;">Email-id: </label>
      <input type="text" name="email" required/>
      <label for="email" style="margin-left:250px;">Address: </label>
      <textarea name="address" style="width:250px;height:50px;"required></textarea>
      <br/><br/>
