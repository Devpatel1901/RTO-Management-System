...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/js/bootstrap.bundle.min.js" integrity="sha384-b5kHyXgcpbZJO/tY9Ul7kGkf1S0CWuKcCD38l8YkeH8z8QjE0GmW1gYU5S9FOnJ0" crossorigin="anonymous"></script>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <br/><br/><br/>
      <form action="dl_verification.php" method="post">
      <label for="aadhar number" style="margin-left:200px;">Aadhaar number: </label> 
      <input type="text" name="aadhaar" placeholder="<?php echo $Aadhaar;?>"required/>
      <label for="Name" style="margin-left:200px;">Name: </label> 
      <input type="text" name="name" placeholder="<?php echo $name;?>"required/>
      <label for="email" style="margin-left:200px;">Email_id: </label> 
      <input type="text" name="email" placeholder="<?php echo $email_id;?>"required/>
      <br/><br/>
      ...
      <br/><br/>
      <p style="margin-left:200px;">Select the Category of Vehicle: 
      <input type="checkbox" name="type" value="LMV" style="margin-left:3px;"> LMV<br/>
      <input type="checkbox" name="type" value="MCWG" style="margin-left:220px;"> MCWG<br/>
      <input type="checkbox" name="type" value="HPMV" style="margin-left:220px;"> HPMV<br/>
      <input type="checkbox" name="type" value="HGMV" style="margin-left:220px;"> HGMV<br/>
      <input type="checkbox" name="type" value="MCWoG" style="margin-left:220px;"> MCWoG<br/><br/>
      <button type="submit"  name="submit" class="btn btn-primary" style="margin-left:450px;text-align:center;">Submit</button>
      </form>
</body>
</html>