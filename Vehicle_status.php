...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/js/bootstrap.bundle.min.js" integrity="sha384-b5kHyXgcpbZJO/tY9Ul7kGkf1S0CWuKcCD38l8YkeH8z8QjE0GmW1gYU5S9FOnJ0" crossorigin="anonymous"></script>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <h3 style="text-align:center;margin-left:70px;margin-top:80px;font-size:45px;color:darkgreen;"><u>Check Status of Registration</u></h3>
      <br/><br/><br/>
      <form action="reg_check_validate.php" method="post">
      <label for="r_id" style="margin-left:630px;">Registration ID: </label>
      <input type="text" name="r_id" required/><br/><br/><br/>
