...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/js/bootstrap.bundle.min.js" integrity="sha384-b5kHyXgcpbZJO/tY9Ul7kGkf1S0CWuKcCD38l8YkeH8z8QjE0GmW1gYU5S9FOnJ0" crossorigin="anonymous"></script>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <h3 style="text-align:center;margin-left:50px;margin-top:80px;font-size:45px;color:darkgreen;"><u>RTO Gujarat: Driving License Application Details</u></h3>
      <br/><br/><br/><br/>
      ...
      <?php
        ...
        if($result = mysqli_query($link, $sql))
        {
            ...
            {
                echo "<table border='2' style='margin-left:350px;border-color:lightgrey;border-collapse: collapse;'>";
                    echo "<thead>";
                        echo "<tr>";
                            echo "<th>DL ID</th>";
                            echo "<th>Name</th>";
                            ...
                            echo "<th>Email_id</th>";
                            echo "<th>City</th>";
                            echo "<th>DL Status</th>";
                            echo "<th>DL issue Date</th>";
                            echo "<th>Action</th>";
                        echo "</tr>";
                    echo "</thead>";
                    echo "<tbody>";
                    while($row = mysqli_fetch_array($result)){
                        ...
                        echo "<tr>";
                            ...
                            echo "<td>" . $row['cov'] . "</td>";
                            echo "<td>" . '<a href="mailto:'.$row['mail_id'].'?subject='.$subject.'&body='.$body.'">'.$row['mail_id'].'</a>' . "</td>";
                            echo "<td>" . $row['City'] . "</td>";
                            echo "<td>" . $row['dl_status'] . "</td>";
                            echo "<td>" . $row['dl_issue_date'] . "</td>";
                            echo "<td>";
                              if($row['dl_status'] == 0)
                              {
                                echo "<a href='approve_dl_application.php?id=" . $row['dl_id'] . "'>Approve Application</a>";
                                echo "&nbsp;";
                              }
                              else
                              {
